    ...
    <section class="bg-emerald-50 min-h-screen flex items-center justify-center">
        ...
        <div class="bg-white flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div class="md:w-1/2 px-8 md:px-16">
            ...
            <form action="" class="flex flex-col gap-1.5">
              ...
              <input type="number" class="p-2 rounded-xl border" name="NIM" placeholder="NIM">
              ...
              <button class="p-2 mt-5 bg-[#739072] rounded-xl text-white font-bold py-2 hover:scale-105 duration-300">Submit</button>
            </form>
